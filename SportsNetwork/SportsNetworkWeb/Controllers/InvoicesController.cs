...
namespace SimplexInvoiceWeb.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult GetInvoice([DataSourceRequest]DataSourceRequest request, int jobTicketId)
        {
            ...
            invoice.Qty = jobTicket.Quantity.ToString("N");
            invoice.POD = jobTicket.POD;
            invoice.Comment = jobTicket.Comments;
            invoice.DeliveryAgent = jobTicket.DeliveryAgent;
            invoice.Weight = jobTicket.Weight.ToString("N");
            invoice.MilageCharge = jobTicket.Milage.ToString("N");
            invoice.TollCharge = jobTicket.Toll.ToString("N");
            invoice.FuelCharge = jobTicket.FuelSurcharge.ToString("N");
            invoice.MiscServiceCharge = jobTicket.MiscFee.ToString("N");
            invoice.TotalCharge = jobTicket.TotalCharge.ToString("N");
